...
class ChampionLabel(QLabel):
    def __init__(self, champion, parent):
        ...
        self.parent = parent
        try:
            self.setPixmap(QPixmap(self.champion["Icon"]).scaled(64, 64, Qt.KeepAspectRatio, Qt.SmoothTransformation))
...
class TeamLabel(QLabel):
    ...
    def set_champion(self, champion):
        ...
        if champion:
            try:
                self.setPixmap(QPixmap(champion["Icon"]).scaled(64, 64, Qt.KeepAspectRatio, Qt.SmoothTransformation))
